...
import aegismatrix.com.asiangis.MainActivity;
import aegismatrix.com.asiangis.R;
...
public class AsianGISHelper {
    ...
    public void autoLoginIntoGIS(Context inContext, WebView inView) {
        String prefName = inContext.getResources().getString(R.string.asian_fabtec_user_prefs);
